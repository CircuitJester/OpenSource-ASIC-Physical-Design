...
read_verilog /project/yosys/asic/axi_master_mapped.v
link_design axi_master_top

read_sdc /project/constraints/axi_master.sdc

report_design_area
report_checks -path_delay max -fields {slew cap input_pin} -digits 3

write_db /project/openroad/axi_master/1_synth.odb
write_sdc /project/openroad/axi_master/1_synth.sdc

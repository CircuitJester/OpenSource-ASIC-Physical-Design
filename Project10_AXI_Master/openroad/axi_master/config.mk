export DESIGN_NAME = axi_master_top
export DESIGN_NICKNAME = axi_master
export PLATFORM = nangate45

export VERILOG_FILES = /project/yosys/asic/axi_master_mapped.v
export SDC_FILE = /project/constraints/axi_master.sdc

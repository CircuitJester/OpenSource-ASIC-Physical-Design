export DESIGN_NAME = sdram_top
export DESIGN_NICKNAME = sdram_controller
export PLATFORM = nangate45

export VERILOG_FILES = /project/yosys/asic/sdram_controller_mapped.v
export SDC_FILE = /project/constraints/sdram_controller.sdc

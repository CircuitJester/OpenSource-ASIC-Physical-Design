...
export DESIGN_NICKNAME = uart_controller
export PLATFORM = nangate45

export VERILOG_FILES = /project/yosys/asic/uart_controller_mapped.v
export SDC_FILE = /project/constraints/uart_controller.sdc

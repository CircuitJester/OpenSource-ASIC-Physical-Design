export DESIGN_NAME = interrupt_controller_top
export DESIGN_NICKNAME = interrupt_controller
export PLATFORM = nangate45

export VERILOG_FILES = /project/yosys/asic/interrupt_controller_top_mapped.v
export SDC_FILE = /project/constraints/interrupt_controller_top.sdc
